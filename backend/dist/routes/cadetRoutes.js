...
router.get('/district', (0, authMiddleware_1.authenticateToken)(), (0, authMiddleware_1.requireRole)('district_admin', 'super_admin'), (0, handlers_1.asHandler)(cadetController_1.getCadetsForDistrictAdmin));
